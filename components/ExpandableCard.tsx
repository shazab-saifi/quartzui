      ...
      {!isOpen ? (
        ...
        >
          <motion.div layoutId="image">
            <Image
              src="https://images.unsplash.com/photo-1559613671-dfe2fb6a7680?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="iphone"
              width={250}
              height={250}
