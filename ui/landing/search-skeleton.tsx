  ...
  return (
    ...
    >
      <motion.div
        ...
        aria-hidden="true"
        className="absolute -top-0.5 left-0 h-0.5 w-full bg-linear-to-r from-transparent from-20% via-neutral-300 via-50% to-transparent to-80% dark:via-neutral-600"
      />
