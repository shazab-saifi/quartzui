...
const Cta = () => {
  return (
    <section className="mt-24 flex flex-col items-center justify-center border-t border-neutral-200 px-4 py-28 sm:px-8 md:mt-32 md:py-36 lg:px-20 2xl:px-60 dark:border-neutral-800">
      <Image
