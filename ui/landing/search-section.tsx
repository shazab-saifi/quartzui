...
const SearchSection = () => {
  return (
    <div className="mt-24 bg-linear-to-b from-neutral-100 to-white to-28% px-4 pt-28 sm:px-8 md:mt-36 lg:px-20 2xl:px-60 dark:from-neutral-900 dark:to-neutral-950">
