...
export default function Footer() {
  ...
  return (
    <footer className="mt-16 w-full border-t border-neutral-200/60 px-4 py-8 text-sm text-neutral-600 sm:mt-20 sm:px-20 sm:py-12 lg:mt-24 lg:py-14 xl:px-70 dark:border-neutral-800/60 dark:text-neutral-400">
