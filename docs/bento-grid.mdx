...
<InstallToggle
  cliCode="npx shadcn@latest add https://quartzui.shazab.site/registry/bento-grid.json"
  ...
  const BentoGridItem = ({
    ...
    return (
      ...
      >
        <div className="h-[65%] w-full rounded-xl bg-linear-to-l from-neutral-800 to-neutral-900" />
