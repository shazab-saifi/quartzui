...
<InstallToggle
  cliCode="npx shadcn@latest add https://quartzui.shazab.site/registry/animated-button.json"
  ...
  const AnimatedButton = ({
    ...
    return (
      ...
      >
        <div
          className="pointer-events-none absolute inset-0 z-0 h-full w-full scale-[1.4] animate-spin rounded-full bg-[conic-gradient(at_center,transparent,#00b4d8_20%,transparent_30%)] animation-duration-[2s]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-0 z-10 h-full w-full scale-[1.4] animate-spin rounded-full bg-[conic-gradient(at_center,transparent,#0077b6_20%,transparent_30%)] [animation-delay:1s] animation-duration-[2s]"
          aria-hidden="true"
        />
