    ...
    >
      <div className="space-y-9">
        <div className="space-y-md md:space-y-6">
          <div
            className={`text-lg font-semibold ${isProfessional ? 'text-neutral-100' : 'text-neutral-400'}`}
          >
            {plan.title}
          </div>
          <div>
        ...
        <div className="space-y-4">
          {plan.offerings.map((item, idx) => (
            <div
              key={idx}
              className={`flex gap-2 text-sm ${isProfessional ? 'text-neutral-100' : 'text-neutral-400'}`}
            >
      ...
      <Button size="sm" variant={isProfessional ? 'secondary' : 'primary'}>
        Get {plan.title} Now
      </Button>
    </div>
  );
...
const page = () => {
  ...
  return (
    <div className="mt-16 space-y-24 md:space-y-32 lg:space-y-40 xl:space-y-50">
